...
`).trim()}function te(e){return`${e}_${Date.now().toString(36)}_${crypto.randomUUID().slice(0,8)}`}function w(e,t,n){return{id:te(`file`),folderId:e,name:t,content:n,questions:g(n),importedAt:Date.now()}}function ne(e,t){return{...e,files:e.files.filter(e=>e.id!==t),attempts:e.attempts.filter(e=>e.fileId!==t),answerOverrides:e.answerOverrides.filter(e=>e.fileId!==t),examDrafts:e.examDrafts.filter(e=>e.fileId!==t)}}function T(e,t,n){let r=new Set(e.files.filter(e=>e.folderId===t).map(e=>e.id)),i=e.folders.filter(e=>e.id!==t);return{...e,folders:i.length>0?i:[n()],files:e.files.filter(e=>!r.has(e.id)),attempts:e.attempts.filter(e=>!r.has(e.fileId)),answerOverrides:e.answerOverrides.filter(e=>!r.has(e.fileId)),examDrafts:e.examDrafts.filter(e=>!r.has(e.fileId))}}var re=`# 정보처리기사 실기 개념요약본 (1~5과목)
...
`),questions:r,importedAt:Math.max(...n.map(e=>e.importedAt))}}function fe(e,t,n){if(e===null)return null;let r=t===`sequential`?e.questions:pe(e.questions,e.id,n);return{...e,questions:r.map((e,t)=>({...e,index:t+1}))}}function pe(e,t,n){if(e.length<2)return e;let r=n%(e.length-1)+1,i=e[r];if(i===void 0)return e;let a=e.filter((e,t)=>t!==r),o=O(`${t}_${n}`);for(let e=a.length-1;e>0;--e){o=k(o);let t=o%(e+1),n=a[e],r=a[t];n===void 0||r===void 0||(a[e]=r,a[t]=n)}return[i,...a]}function O(e){let t=0;for(let n of e)t=t*31+n.charCodeAt(0)>>>0;return t}function k(e){return e*1664525+1013904223>>>0}var me={folders:[],files:[],attempts:[],answerOverrides:[],examDrafts:[]},he=`STUDY_VIEWER_LIBRARY_V1`;function ge(e=window.localStorage){return{load:()=>_e(e),saveLibrary:t=>ve(e,t),saveFolders:t=>ve(e,{..._e(e),folders:t}),saveFiles:t=>ve(e,{..._e(e),files:t}),saveAttempts:t=>ve(e,{..._e(e),attempts:t}),saveAnswerOverrides:t=>ve(e,{..._e(e),answerOverrides:t}),saveExamDrafts:t=>ve(e,{..._e(e),examDrafts:t})}}function _e(e){let t=e.getItem(he);if(t===null)return me;let n=JSON.parse(t);return{folders:Array.isArray(n.folders)?n.folders:[],files:Array.isArray(n.files)?n.files:[],attempts:Array.isArray(n.attempts)?n.attempts:[],answerOverrides:Array.isArray(n.answerOverrides)?n.answerOverrides:[],examDrafts:Array.isArray(n.examDrafts)?n.examDrafts:[]}}function ve(e,t){e.setItem(he,JSON.stringify(t))}var ye=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),A=e(((e,t)=>{t.exports=ye()}))();function be(e){let[t,n]=(0,l.useState)(!1),[r,i]=(0,l.useState)(!1),a=e.files.find(t=>t.id===e.selectedFileId)?.name??`파일을 선택하세요`;return(0,A.jsxs)(`aside`,{"aria-label":`Sidebar`,className:[`sidebar`,t?`collapsed`:``,r?`mobile-expanded`:``].filter(Boolean).join(` `),children:[(0,A.jsx)(`button`,{"aria-label":t?`사이드바 펼치기`:`사이드바 접기`,className:t?`sidebar-expand-toggle`:`sidebar-collapse-toggle`,type:`button`,onClick:()=>n(e=>!e),children:t?`>`:`<`}),(0,A.jsxs)(`button`,{"aria-expanded":r,"aria-label":r?`파일 메뉴 접기`:`파일 메뉴 펼치기`,className:`mobile-file-summary`,type:`button`,onClick:()=>i(e=>!e),children:[(0,A.jsx)(`span`,{"aria-hidden":`true`,children:a}),(0,A.jsx)(Te,{})]}),(0,A.jsxs)(`div`,{className:`sidebar-content`,children:[(0,A.jsxs)(`div`,{className:`brand`,children:[(0,A.jsx)(`div`,{className:`brand-icon`,children:`SV`}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h1`,{children:`STUDY_VIEWER`}),(0,A.jsx)(`p`,{children:`Local exam workspace`})]})]}),(0,A.jsx)(`nav`,{className:`tree`,"aria-label":`folder tree`,children:e.folders.map(t=>(0,A.jsxs)(`section`,{className:`folder-block`,children:[(0,A.jsxs)(`div`,{className:`tree-item`,children:[(0,A.jsxs)(`button`,{className:t.id===e.selectedFolderId?`tree-row active`:`tree-row`,type:`button`,onClick:()=>e.onSelectFolder(t.id),children:[(0,A.jsx)(Ce,{}),(0,A.jsx)(`span`,{children:t.name})]}),e.isDeleteMode?(0,A.jsx)(xe,{label:`${t.name} 폴더 삭제`,onClick:()=>e.onDeleteFolder(t.id)}):null]}),e.files.filter(e=>e.folderId===t.id).map(t=>(0,A.jsxs)(`div`,{className:`tree-item file-item`,children:[(0,A.jsxs)(`button`,{className:t.id===e.selectedFileId?`file-row active`:`file-row`,type:`button`,onClick:()=>e.onSelectFile(t.id),children:[(0,A.jsx)(`span`,{children:t.name}),(0,A.jsxs)(`small`,{children:[t.questions.length,`문제`]})]}),e.isDeleteMode?(0,A.jsx)(xe,{label:`${t.name} 파일 삭제`,onClick:()=>e.onDeleteFile(t.id)}):null]},t.id))]},t.id))}),(0,A.jsxs)(`div`,{className:`sidebar-actions`,children:[(0,A.jsx)(`button`,{className:`primary`,type:`button`,onClick:e.onAddFolder,children:`Add Folder`}),(0,A.jsx)(`button`,{"aria-pressed":e.isDeleteMode,className:e.isDeleteMode?`danger active`:`danger`,type:`button`,onClick:e.onToggleDeleteMode,children:e.isDeleteMode?`Deleting...`:`Delete`}),(0,A.jsxs)(`label`,{className:`secondary`,children:[`Import File`,(0,A.jsx)(`input`,{"aria-label":`md/txt 불러오기`,accept:`.md,.txt,text/markdown,text/plain`,type:`file`,onChange:t=>{let n=t.currentTarget.files?.[0];n!==void 0&&e.onImportFile(n),t.currentTarget.value=``}})]})]}),(0,A.jsx)(`button`,{"aria-label":`모바일 낮/밤 전환`,"aria-pressed":e.theme===`resend`,className:`theme-toggle`,type:`button`,onClick:e.onToggleTheme,children:(0,A.jsx)(Se,{})})]})]})}function xe({label:e,onClick:t}){return(0,A.jsx)(`button`,{"aria-label":e,className:`delete-mark`,type:`button`,onClick:e=>{e.stopPropagation(),t()},children:`x`})}function Se(){return(0,A.jsx)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`18`,viewBox:`0 0 24 24`,width:`18`,xmlns:`http://www.w3.org/2000/svg`,children:(0,A.jsx)(`path`,{d:`M20.2 15.4A8.6 8.6 0 0 1 8.6 3.8a8.7 8.7 0 1 0 11.6 11.6Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function Ce(){return(0,A.jsx)(`svg`,{"aria-hidden":`true`,className:`folder-icon`,fill:`none`,height:`16`,viewBox:`0 0 24 24`,width:`16`,xmlns:`http://www.w3.org/2000/svg`,children:(0,A.jsx)(`path`,{d:`M3.8 6.6c0-.9.7-1.6 1.6-1.6h4.2l2 2h7c.9 0 1.6.7 1.6 1.6v8.8c0 .9-.7 1.6-1.6 1.6H5.4c-.9 0-1.6-.7-1.6-1.6V6.6Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function we({mode:e,theme:t,onChangeMode:n,onToggleTheme:r}){let[i,a]=(0,l.useState)(!1);return(0,A.jsxs)(`header`,{className:`topbar`,children:[(0,A.jsxs)(`div`,{className:`topbar-title`,children:[(0,A.jsx)(`strong`,{children:`Workspace Reader`}),(0,A.jsx)(`button`,{"aria-label":`Resend night theme`,"aria-pressed":t===`resend`,className:`mobile-theme-toggle`,type:`button`,onClick:r,children:(0,A.jsx)(Se,{})})]}),(0,A.jsxs)(`nav`,{children:[[{mode:`single`,label:`단건보기`},{mode:`all`,label:`모두보기`},{mode:`exam`,label:`시험보기`},{mode:`stats`,label:`통계`}].map(t=>(0,A.jsx)(`button`,{className:e===t.mode?`tab active`:`tab`,type:`button`,onClick:()=>n(t.mode),children:t.label},t.mode)),(0,A.jsx)(`button`,{"aria-expanded":i,"aria-label":`검색 열기`,className:`search-toggle`,type:`button`,onClick:()=>a(e=>!e),children:(0,A.jsx)(Ee,{})})]}),(0,A.jsx)(`input`,{"aria-label":`Search files`,className:i?`search-input open`:`search-input`,placeholder:`Search files...`})]})}function Te(){return(0,A.jsx)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`18`,viewBox:`0 0 24 24`,width:`18`,xmlns:`http://www.w3.org/2000/svg`,children:(0,A.jsx)(`path`,{d:`m6 9 6 6 6-6`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function Ee(){return(0,A.jsx)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`18`,viewBox:`0 0 24 24`,width:`18`,xmlns:`http://www.w3.org/2000/svg`,children:(0,A.jsx)(`path`,{d:`m21 21-4.3-4.3M10.8 18a7.2 7.2 0 1 1 0-14.4 7.2 7.2 0 0 1 0 14.4Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function De(){return(0,A.jsxs)(`div`,{className:`empty`,children:[(0,A.jsx)(`h2`,{children:`파일을 불러오면 문제가 표시됩니다.`}),(0,A.jsx)(`p`,{children:`왼쪽 메뉴에서 md/txt 파일을 불러오세요.`})]})}function Oe({message:e}){return(0,A.jsx)(`div`,{className:e.length>0?`toast show`:`toast`,children:e})}function ke(e,t){let n=new Map;for(let r of e)r.fileId===t&&n.set(r.questionId,r.answer);return n}function Ae(e,t=new Map){return t.get(e.id)??e.answer}var je=/\(([^()]*)\)|（([^（）]*)）/gu,Me=/[\s,，、→⇒]+|[-=]+>/gu;function Ne(e){return e.normalize(`NFC`).trim().replace(/^[\s.,;:!?。、，]+|[\s.,;:!?。、，]+$/gu,``).replace(/\s+/gu,` `).toLocaleLowerCase(`ko-KR`)}function Pe(e,t){if(t===null)return!1;let n=Fe(e);return n.length>0&&Ie(t).includes(n)}function Fe(e){return Ne(e).replace(Me,``)}function Ie(e){return ze([e,Le(e),...Re(e)])}function Le(e){return e.replace(je,` `).trim()}function Re(e){let t=[];for(let n of e.matchAll(je)){let e=(n[1]??n[2]??``).trim();e.length>0&&t.push(e)}return t}function ze(e){let t=[],n=new Set;for(let r of e){let e=Fe(r);e.length===0||n.has(e)||(n.add(e),t.push(e))}return t}function Be(e,t,n=new Map){let r={},i=0,a=0;for(let o of e){let e=Ae(o,n);if(e===null)continue;a+=1;let s=Pe(t[o.id]??``,e);r[o.id]=s,s&&(i+=1)}return{results:r,score:i,total:a}}function Ve(e){let t=e.index>=e.total-1;function n(t){if(!(e.disabled||t.nativeEvent.isComposing)){if(t.key===`Enter`&&!t.shiftKey){t.preventDefault(),t.stopPropagation(),e.onSave();return}if(t.key===`ArrowLeft`){t.preventDefault(),t.stopPropagation(),e.onPrev();return}t.key===`ArrowRight`&&(t.preventDefault(),t.stopPropagation(),e.onNext())}}return(0,A.jsxs)(`footer`,{className:`answer-footer`,children:[(0,A.jsxs)(`section`,{children:[(0,A.jsx)(`h3`,{children:`답안 작성 영역`}),(0,A.jsx)(`textarea`,{value:e.answer,onChange:t=>e.onAnswer(t.currentTarget.value),onKeyDown:n,placeholder:`답을 입력하세요`,disabled:e.disabled}),(0,A.jsx)(`div`,{className:`footer-buttons`,children:(0,A.jsx)(`button`,{className:`primary`,type:`button`,onClick:e.onSave,disabled:e.question===null||e.disabled,children:`저장`})})]}),(0,A.jsxs)(`nav`,{children:[(0,A.jsx)(`button`,{type:`button`,onClick:e.onPrev,children:`이전 문항`}),(0,A.jsxs)(`strong`,{children:[`QUESTION `,e.total===0?0:e.index+1,` / `,e.total]}),(0,A.jsx)(`button`,{type:`button`,onClick:t?e.onSubmit:e.onNext,children:t?`제출 완료`:`다음 문항`})]})]})}function He(e,t){return t?.includes("`")===!0&&f(t)===e?t:e}function Ue({text:e}){return(0,A.jsx)(`div`,{className:`question-prompt`,children:Ge(e).map(e=>e.kind===`codeBlock`?(0,A.jsx)(`pre`,{className:`question-code-block`,"data-language":e.language,children:(0,A.jsx)(`code`,{children:Je(e.value,e.id,e.language)})},e.id):(0,A.jsx)(`p`,{children:qe(e.value,e.id)},e.id))})}function We({text:e}){return(0,A.jsx)(A.Fragment,{children:qe(e,`inline`)})}function Ge(e){let t=[],n=[],r=[],i=`plaintext`,a=!1;for(let o of e.split(`
`)){let e=Ye(o);if(e!==null){if(a){t.push({id:`code-${t.length}-${r.join(`
`).length}`,kind:`codeBlock`,language:i,value:r.join(`
`)}),r.length=0,i=`plaintext`,a=!1;continue}Ke(t,n),i=e,a=!0;continue}if(a){r.push(o);continue}n.push(o)}return a&&t.push({id:`code-${t.length}-${r.join(`
`).length}`,kind:`codeBlock`,language:i,value:r.join(`
`)}),Ke(t,n),t.length>0?t:[{id:`text-empty-${e.length}`,kind:`text`,value:e}]}function Ke(e,t){if(t.length===0)return;let n=t.join(`
`).trim();t.length=0,n.length!==0&&e.push({id:`text-${e.length}-${n.length}`,kind:`text`,value:n})}function qe(e,t){let n=[],r=e,i=0;for(;r.length>0;){let e=r.indexOf("`");if(e<0){n.push(r);break}let a=r.slice(0,e);a.length>0&&n.push(a);let o=r.slice(e+1),s=o.indexOf("`");if(s<0){n.push(r.slice(e));break}let c=o.slice(0,s);n.push((0,A.jsx)(`code`,{className:`question-inline-code`,children:c},`code-${t}-${i}`)),i+=1,r=o.slice(s+1)}return n}function Je(e,t,n){let r=[],i=0,a=Ze(n);for(let o of e.matchAll(a)){let a=o[0],s=o.index;s>i&&r.push(e.slice(i,s)),r.push((0,A.jsx)(`span`,{className:`code-token ${$e(a,n)}`,children:a},`${t}-${s}`)),i=s+a.length}return i<e.length&&r.push(e.slice(i)),r}function Ye(e){let t=/^\s*```(?<language>[a-z0-9_-]*)/iu.exec(e);return t===null?null:Xe(t.groups?.language??``)}function Xe(e){let t=e.toLowerCase();return t===`js`||t===`jsx`?`javascript`:t===`ts`||t===`tsx`?`typescript`:t===`py`?`python`:t===`kt`?`kotlin`:t===`md`?`markdown`:t===`htm`?`html`:t===`css`||t===`html`||t===`java`||t===`json`||t===`kotlin`||t===`markdown`||t===`python`||t===`sql`||t===`typescript`?t:`plaintext`}function Ze(e){let t=Qe(e);return new RegExp([/#.*/u.source,/--.*/u.source,/\/\/.*/u.source,/"(?:\\.|[^"\\])*"/u.source,/'(?:\\.|[^'\\])*'/u.source,/`(?:\\.|[^`\\])*`/u.source,t,/\b\d+(?:\.\d+)?\b/u.source].filter(e=>e.length>0).join(`|`),`gu`)}function Qe(e){let t={css:[`align-items`,`background`,`border`,`color`,`display`,`font`,`grid`,`margin`,`padding`],html:[`article`,`body`,`button`,`div`,`footer`,`head`,`header`,`html`,`main`,`section`],java:[`boolean`,`class`,`else`,`false`,`final`,`if`,`import`,`new`,`null`,`private`,`public`,`return`,`static`,`true`,`void`],javascript:[`async`,`await`,`class`,`const`,`else`,`export`,`false`,`from`,`function`,`if`,`import`,`let`,`new`,`null`,`return`,`true`,`undefined`,`var`,`while`],json:[`false`,`null`,`true`],kotlin:[`class`,`data`,`else`,`false`,`fun`,`if`,`import`,`null`,`object`,`return`,`true`,`val`,`var`,`when`],markdown:[],plaintext:[],python:[`and`,`as`,`class`,`def`,`elif`,`else`,`False`,`for`,`from`,`if`,`import`,`in`,`is`,`None`,`not`,`or`,`return`,`True`,`while`],sql:[`and`,`as`,`by`,`case`,`create`,`delete`,`from`,`group`,`insert`,`into`,`join`,`left`,`limit`,`order`,`right`,`select`,`table`,`update`,`values`,`where`],typescript:[`async`,`await`,`class`,`const`,`else`,`export`,`false`,`from`,`function`,`if`,`import`,`interface`,`let`,`new`,`null`,`return`,`true`,`type`,`undefined`,`var`,`while`]}[e].join(`|`);return t.length===0?``:`\\b(?:${t})\\b`}function $e(e,t){return e.startsWith(`//`)||e.startsWith(`#`)||e.startsWith(`--`)?`comment`:e.startsWith(`"`)||e.startsWith(`'`)||e.startsWith("`")?`string`:/^\d/u.test(e)?`number`:t===`css`&&e.includes(`-`)?`property`:t===`html`?`tag`:`keyword`}function et({question:e,correctAnswer:t,reference:n,answer:r,isSaved:i}){let a=Pe(r,t);return(0,A.jsxs)(`article`,{className:`question-card`,children:[(0,A.jsxs)(`div`,{className:`question-meta`,children:[(0,A.jsxs)(`span`,{children:[`Question `,e.index.toString().padStart(2,`0`)]}),(0,A.jsx)(`small`,{children:n})]}),(0,A.jsx)(Ue,{text:e.prompt}),i?(0,A.jsx)(tt,{answer:t,rawAnswer:e.rawAnswer,isCorrect:a}):null]})}function tt({answer:e,rawAnswer:t,isCorrect:n}){if(e===null)return null;let r=He(e,t);return(0,A.jsxs)(`div`,{className:`exam-saved-answer`,children:[(0,A.jsxs)(`div`,{className:`exam-answer-line`,children:[(0,A.jsx)(`span`,{children:(0,A.jsx)(We,{text:`정답: ${r}`})}),(0,A.jsx)(`button`,{"aria-label":`정답 복사`,className:`answer-copy`,title:`정답 복사`,type:`button`,onClick:()=>{nt(r)},children:(0,A.jsxs)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`14`,viewBox:`0 0 24 24`,width:`14`,children:[(0,A.jsx)(`path`,{d:`M8 8h11v11H8z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`}),(0,A.jsx)(`path`,{d:`M5 16H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v1`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`})]})})]}),(0,A.jsx)(`strong`,{className:n?`result correct`:`result wrong`,children:n?`정답입니다`:`오답입니다`})]})}async function nt(e){if(navigator.clipboard!==void 0){await navigator.clipboard.writeText(e);return}let t=document.createElement(`textarea`);t.value=e,t.setAttribute(`readonly`,``),t.style.position=`fixed`,t.style.opacity=`0`,document.body.append(t),t.select(),document.execCommand(`copy`),t.remove()}function rt({questions:e,answers:t,overrideMap:n,savedQuestionIds:r}){let i=[],a=[];return e.forEach((e,o)=>{let s=t[e.id]??``,c=Ae(e,n);if(c===null||!r.has(e.id)||s.trim().length===0)return;let l=Pe(s,c),u={index:o,label:`${l?`정답문항`:`오답문항`} ${o+1}. ${it(e.prompt)}`};l?i.push(u):a.push(u)}),{correctItems:i,failedItems:a}}function it(e){let t=e.replace(/\s+/gu,` `).trim();return t.length<=36?t:`${t.slice(0,36)}...`}function at({correctItems:e,failedItems:t,isCompact:n=!1,total:r,timerText:i,orderMode:a,onToggleOrder:o,onReset:s,onSelectQuestion:c}){let l=e.length+t.length,u=r===0?0:Math.round(l/r*100);return(0,A.jsxs)(`section`,{"aria-label":`시험 진행도`,className:n?`progress-strip compact`:`progress-strip`,children:[(0,A.jsxs)(`div`,{className:`progress-status`,children:[(0,A.jsx)(ot,{label:`정답 수`,ariaLabel:`정답 문항 이동`,summary:`${e.length} / ${r}`,emptyText:`정답문항 없음`,items:e,onSelectQuestion:c}),(0,A.jsx)(ot,{label:`오답 수`,ariaLabel:`오답 문항 이동`,summary:`${t.length} / ${r}`,emptyText:`오답문항 없음`,items:t,onSelectQuestion:c})]}),(0,A.jsx)(ct,{orderMode:a,onToggleOrder:o}),(0,A.jsxs)(`div`,{className:`progress-actions`,children:[(0,A.jsx)(`span`,{className:`progress-label`,children:`진행도`}),(0,A.jsx)(`div`,{"aria-label":`진행도 ${l} / ${r}`,"aria-valuemax":r,"aria-valuemin":0,"aria-valuenow":l,className:`bar`,role:`progressbar`,children:(0,A.jsx)(`div`,{style:{width:`${u}%`}})}),(0,A.jsxs)(`div`,{className:`progress-time`,children:[s===void 0?null:(0,A.jsx)(`button`,{"aria-label":`새로고침`,className:`timer-reset`,type:`button`,onClick:s,children:`↻`}),i===void 0?null:(0,A.jsx)(`span`,{className:`timer-chip`,children:i})]})]})]})}function ot({label:e,ariaLabel:t,summary:n,emptyText:r,items:i,onSelectQuestion:a}){return(0,A.jsxs)(`label`,{className:`progress-picker`,children:[(0,A.jsx)(`span`,{children:e}),(0,A.jsxs)(`select`,{"aria-label":t,value:``,onChange:e=>{let{value:t}=e.currentTarget;if(t===``)return;let n=Number(t);Number.isInteger(n)&&a(n)},children:[(0,A.jsx)(`option`,{value:``,children:n}),i.length===0?(0,A.jsx)(`option`,{disabled:!0,children:r}):i.map(e=>(0,A.jsx)(`option`,{value:e.index,children:e.label},e.index))]})]})}function st({orderMode:e,onToggleOrder:t}){return(0,A.jsx)(`section`,{className:`order-strip`,children:(0,A.jsx)(ct,{orderMode:e,onToggleOrder:t})})}function ct({orderMode:e,onToggleOrder:t}){return(0,A.jsx)(`button`,{className:`order-toggle`,type:`button`,onClick:t,children:e===`sequential`?`순차`:`무작위`})}function lt({file:e,attempts:t,examDrafts:n,answerOverrides:r,currentIndex:i,isChromeCollapsed:a,orderMode:o,onToggleOrder:s,onMove:c,onToggleChrome:u,onSaveAttempt:d,onSaveExamDraft:f,onClearExamDraft:p}){let m=ft(t,e.id),h=n.find(t=>t.fileId===e.id)??null,g=h===null?m:null,[_,v]=(0,l.useState)(h?.startedAt??Date.now()),[y,b]=(0,l.useState)(Date.now()),[x,ee]=(0,l.useState)(()=>h?.answers??g?.answers??{}),[S,C]=(0,l.useState)(()=>new Set(Object.keys(h?.answers??g?.answers??{})));(0,l.useEffect)(()=>{if(g!==null)return;let e=window.setInterval(()=>b(Date.now()),1e3);return()=>window.clearInterval(e)},[g]),(0,l.useEffect)(()=>{let e=h?.answers??g?.answers??{};ee(e),v(h?.startedAt??g?.startedAt??Date.now()),C(new Set(Object.keys(e))),b(Date.now())},[h,g]);let w=e.questions[i]??null,ne=ke(r,e.id),T=rt({questions:e.questions,answers:x,overrideMap:ne,savedQuestionIds:S}),re=ht(g?.durationMs??y-_),ie=g!==null;(0,l.useEffect)(()=>{if(ie)return;function t(t){if(!t.defaultPrevented){if(t.key===`ArrowLeft`){t.preventDefault(),c(Math.max(0,i-1));return}t.key===`ArrowRight`&&(t.preventDefault(),c(Math.min(e.questions.length-1,i+1)))}}return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[i,e.questions.length,ie,c]);function ae(){c(Math.max(0,i-1))}function oe(){c(Math.min(e.questions.length-1,i+1))}function se(){if(w===null)return!1;let t=x;return f({fileId:e.id,answers:t,startedAt:_}),C(e=>new Set(e).add(w.id)),i>=e.questions.length-1?ce(t):(Pe(t[w.id]??``,Ae(w,ne))&&i<e.questions.length-1&&c(i+1),!0)}function ce(n){if(ie)return window.alert(`이미 제출 완료된 데이터입니다`),!1;if(w===null)return!1;let r=Date.now(),i=Be(e.questions,n,ne);return d({id:te(`attempt`),fileId:e.id,round:t.filter(t=>t.fileId===e.id).length+1,answers:n,results:i.results,score:i.score,total:i.total,startedAt:_,finishedAt:r,durationMs:r-_}),p(e.id),C(new Set(e.questions.map(e=>e.id))),window.alert(`저장되었습니다.`),!0}function le(){return ce(x)}function E(){let t=Date.now(),n={};f({fileId:e.id,answers:n,startedAt:t}),v(t),ee(n),C(new Set),c(0),b(t)}return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(at,{correctItems:T.correctItems,failedItems:T.failedItems,isCompact:a,total:e.questions.length,timerText:re,orderMode:o,onToggleOrder:s,onReset:E,onSelectQuestion:c}),(0,A.jsx)(ut,{isCollapsed:a,onToggle:u}),(0,A.jsx)(`div`,{className:`question-scroll`,children:(0,A.jsx)(`div`,{className:`exam`,children:w===null?(0,A.jsx)(pt,{}):(0,A.jsx)(et,{question:w,correctAnswer:Ae(w,ne),reference:`${mt(w,e.name)} · QUESTION ${i+1} / ${e.questions.length}`,answer:x[w.id]??``,isSaved:ie||S.has(w.id)})})}),(0,A.jsx)(Ve,{question:w,index:i,total:e.questions.length,answer:w===null?``:x[w.id]??``,disabled:ie,onAnswer:e=>{w!==null&&ee(t=>({...t,[w.id]:e}))},onSave:se,onPrev:ae,onNext:oe,onSubmit:le})]})}function ut({isCollapsed:e,onToggle:t}){return(0,A.jsx)(`div`,{className:`chrome-collapse-hover`,children:(0,A.jsx)(`button`,{"aria-label":e?`모바일 상단 메뉴 펼치기`:`모바일 상단 메뉴 접기`,className:e?`mobile-chrome-collapse-toggle collapsed`:`mobile-chrome-collapse-toggle`,type:`button`,onClick:t,children:(0,A.jsx)(dt,{pointsDown:e})})})}function dt({pointsDown:e}){return(0,A.jsx)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`18`,viewBox:`0 0 24 24`,width:`18`,xmlns:`http://www.w3.org/2000/svg`,children:(0,A.jsx)(`path`,{d:e?`m6 9 6 6 6-6`:`m6 15 6-6 6 6`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function ft(e,t){return e.filter(e=>e.fileId===t).at(-1)??null}function pt(){return(0,A.jsx)(`div`,{className:`empty`,children:(0,A.jsx)(`h2`,{children:`시험 볼 문제가 없습니다.`})})}function mt(e,t){return e.sourceFolderName!==void 0&&e.sourceFileName!==void 0?`${e.sourceFolderName} - ${e.sourceFileName}`:t}function ht(e){let t=Math.floor(e/1e3);return`${Math.floor(t/3600).toString().padStart(2,`0`)}:${Math.floor(t%3600/60).toString().padStart(2,`0`)}:${(t%60).toString().padStart(2,`0`)}`}function gt({question:e,answer:t,variant:n,onConceal:r,onEdit:i}){let[a,o]=(0,l.useState)(!1),s=(0,l.useRef)(null);return(0,l.useEffect)(()=>()=>{s.current!==null&&window.clearTimeout(s.current)},[]),t===null?null:(0,A.jsxs)(`div`,{className:a?`answer-editable raw-mode`:`answer-editable`,children:[(0,A.jsx)(`button`,{className:n===`mask`?`mask revealed`:`visible-answer`,type:`button`,onClick:e=>{n!==`mask`||r===void 0||e.detail===1&&(s.current=window.setTimeout(r,180))},onDoubleClick:()=>{s.current!==null&&window.clearTimeout(s.current),o(e=>!e)},children:(0,A.jsx)(We,{text:a?e.rawAnswer??t:`정답: ${He(t,e.rawAnswer)}`})}),i===void 0?null:(0,A.jsx)(`button`,{className:`answer-edit`,type:`button`,onClick:()=>{let e=window.prompt(`정답을 수정하세요`,t)?.trim();e===void 0||e.length===0||(i(e),o(!1))},children:`정답 수정`})]})}function _t({question:e,effectiveAnswer:t,revealed:n,onReveal:r,onSaveAnswerOverride:i,reference:a,answerMode:o}){return(0,A.jsxs)(`article`,{className:`question-card`,children:[(0,A.jsxs)(`div`,{className:`question-meta`,children:[(0,A.jsxs)(`span`,{children:[`Question `,e.index.toString().padStart(2,`0`)]}),(0,A.jsx)(`small`,{children:a})]}),(0,A.jsx)(Ue,{text:e.prompt}),o===`mask`?(0,A.jsx)(vt,{question:e,answer:t,revealed:n,onReveal:r,...i===void 0?{}:{onSaveAnswerOverride:i}}):(0,A.jsx)(gt,{question:e,answer:t,variant:`visible`})]})}function vt({question:e,answer:t,revealed:n,onReveal:r,onSaveAnswerOverride:i}){return t===null?null:n?(0,A.jsx)(gt,{question:e,answer:t,variant:`mask`,onConceal:r,...i===void 0?{}:{onEdit:i}}):(0,A.jsx)(`button`,{className:`mask`,type:`button`,onClick:r,children:`정답 보기`})}function yt(e,t,n){return e.flatMap(e=>e.questions.map(r=>{let i=t.filter(t=>t.fileId===e.id).filter(e=>e.results[r.id]!==void 0),a=i.filter(e=>e.results[r.id]===!1).length,o=i.length,s=o===0?0:a/o;return{questionId:r.id,fileId:e.id,label:`${e.name} · ${r.index}번`,attempts:o,wrong:a,wrongRate:s,highlighted:o>0&&s>=n}}))}var bt=.5;function xt({files:e,attempts:t}){let n=(0,l.useMemo)(()=>yt(e,t,bt),[e,t]);return(0,A.jsxs)(`div`,{className:`stats`,children:[(0,A.jsx)(`h2`,{children:`통계`}),t.length===0?(0,A.jsx)(`p`,{children:`저장된 응시 결과가 없습니다.`}):null,n.map(e=>(0,A.jsxs)(`div`,{className:e.highlighted?`stat-row hot`:`stat-row`,children:[(0,A.jsx)(`span`,{children:e.label}),(0,A.jsxs)(`strong`,{children:[`오답률 `,Math.round(e.wrongRate*100),`%`]}),(0,A.jsxs)(`small`,{children:[e.wrong,`/`,e.attempts]})]},`${e.fileId}_${e.questionId}`))]})}function St(e){return e.mode===`all`?(0,A.jsx)(Tt,{...e}):e.mode===`exam`?(0,A.jsx)(lt,{file:e.file,attempts:e.attempts,examDrafts:e.examDrafts,answerOverrides:e.answerOverrides,currentIndex:e.examIndex,isChromeCollapsed:e.isExamChromeCollapsed,orderMode:e.orderMode,onToggleOrder:e.onToggleOrder,onMove:e.onMoveExam,onToggleChrome:e.onToggleExamChrome,onSaveAttempt:e.onSaveAttempt,onSaveExamDraft:e.onSaveExamDraft,onClearExamDraft:e.onClearExamDraft}):e.mode===`stats`?(0,A.jsx)(xt,{files:[e.file],attempts:e.attempts}):(0,A.jsx)(Ct,{...e})}function Ct(e){if((0,l.useEffect)(()=>{function t(t){if(!(t.defaultPrevented||wt(t.target))){if(t.key===`ArrowLeft`){t.preventDefault(),e.onMove(Math.max(0,e.currentIndex-1));return}t.key===`ArrowRight`&&(t.preventDefault(),e.onMove(Math.min(e.file.questions.length-1,e.currentIndex+1)))}}return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e.currentIndex,e.file.questions.length,e.onMove]),e.currentQuestion===null)return(0,A.jsx)(j,{});let t=e.currentQuestion,n=ke(e.answerOverrides,e.file.id);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(st,{orderMode:e.orderMode,onToggleOrder:e.onToggleOrder}),(0,A.jsx)(`div`,{className:`question-scroll`,children:(0,A.jsx)(_t,{question:t,effectiveAnswer:Ae(t,n),revealed:e.revealed.has(t.id),onReveal:()=>e.onReveal(t.id),onSaveAnswerOverride:n=>e.onSaveAnswerOverride({fileId:e.file.id,questionId:t.id,answer:n,updatedAt:Date.now()}),reference:`${Dt(t,e.file.name)} · QUESTION ${e.currentIndex+1} / ${e.file.questions.length}`,answerMode:`mask`})}),(0,A.jsx)(Et,{index:e.currentIndex,total:e.file.questions.length,onPrev:()=>e.onMove(Math.max(0,e.currentIndex-1)),onNext:()=>e.onMove(Math.min(e.file.questions.length-1,e.currentIndex+1))})]})}function wt(e){if(!(e instanceof HTMLElement))return!1;let t=e.tagName.toLowerCase();return t===`input`||t===`textarea`||t===`select`||e.isContentEditable}function Tt(e){if(e.file.questions.length===0)return(0,A.jsx)(j,{});let t=ke(e.answerOverrides,e.file.id);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(st,{orderMode:e.orderMode,onToggleOrder:e.onToggleOrder}),(0,A.jsx)(`div`,{className:`question-scroll`,children:(0,A.jsx)(`div`,{className:`stack`,children:e.file.questions.map(n=>(0,A.jsx)(_t,{question:n,effectiveAnswer:Ae(n,t),revealed:!1,onReveal:()=>void 0,reference:Dt(n,e.file.name),answerMode:`visible`},n.id))})})]})}function Et({index:e,total:t,onPrev:n,onNext:r}){return(0,A.jsxs)(`footer`,{className:`single-navigation`,children:[(0,A.jsx)(`button`,{type:`button`,onClick:n,children:`이전 문항`}),(0,A.jsxs)(`strong`,{children:[`QUESTION `,t===0?0:e+1,` / `,t]}),(0,A.jsx)(`button`,{type:`button`,onClick:r,children:`다음 문항`})]})}function j(){return(0,A.jsxs)(`div`,{className:`empty`,children:[(0,A.jsx)(`h2`,{children:`표시할 문제가 없습니다.`}),(0,A.jsx)(`p`,{children:`답: 또는 정답: 구문이 없는 파일도 안전하게 불러올 수 있습니다.`})]})}function Dt(e,t){return e.sourceFolderName!==void 0&&e.sourceFileName!==void 0?`${e.sourceFolderName} - ${e.sourceFileName}`:t}var Ot=ge();function kt(){let[e,t]=(0,l.useState)(()=>ae(Ot.load(),Ot.saveLibrary)),[n,r]=(0,l.useState)(()=>e.folders[0]?.id??``),[i,a]=(0,l.useState)(e.files[0]?.id??null),[o,s]=(0,l.useState)(`single`),[c,u]=(0,l.useState)(0),[f,p]=(0,l.useState)(0),[m,h]=(0,l.useState)(new Set),[g,_]=(0,l.useState)(``),[v,y]=(0,l.useState)(`opencode`),[b,x]=(0,l.useState)(!1),[ee,S]=(0,l.useState)(!1),[C,re]=(0,l.useState)(`sequential`),[ie,oe]=(0,l.useState)(0),se=e.files.find(e=>e.id===i)??null,ce=e.folders.find(e=>e.id===n)??e.folders[0],le=(0,l.useMemo)(()=>se??de(ce??null,e.files),[e.files,ce,se]),pe=(0,l.useMemo)(()=>fe(le,C,ie),[C,le,ie]),O=pe?.questions[c]??null;(0,l.useEffect)(()=>{if(g.length===0)return;let e=window.setTimeout(()=>_(``),1800);return()=>window.clearTimeout(e)},[g]);function k(e){Ot.saveFiles(e),t(t=>({...t,files:e}))}function me(e){Ot.saveAttempts(e),t(t=>({...t,attempts:e}))}function he(e){Ot.saveExamDrafts(e),t(t=>({...t,examDrafts:e}))}function ge(n){let r=d(e.answerOverrides,n);Ot.saveAnswerOverrides(r),t(e=>({...e,answerOverrides:r}))}function _e(e){Ot.saveLibrary(e),t(e)}function ve(t){he([...e.examDrafts.filter(e=>e.fileId!==t.fileId),t])}function ye(t){he(e.examDrafts.filter(e=>e.fileId!==t))}function xe(){let n=window.prompt(`폴더명을 입력하세요`,`새 폴더`)?.trim();if(n===void 0||n.length===0)return;let i={id:te(`folder`),name:n,createdAt:Date.now()},o=[...e.folders,i];Ot.saveFolders(o),t(e=>({...e,folders:o})),r(i.id),a(null),u(0),p(0)}async function Se(e){let t=await e.text();Ce(e.name,t)}function Ce(t,n){let r=ce?.id??e.folders[0]?.id;if(r===void 0)return;let i=w(r,t,n);k([...e.files,i]),a(i.id),u(0),p(0),_(`${t} 불러오기 완료`)}function Te(t){let n=ne(e,t);_e(n),i===t&&(a(n.files[0]?.id??null),u(0),p(0)),h(n=>D(n,e.files,t))}function Ee(t){let o=new Set(e.files.filter(e=>e.folderId===t).map(e=>e.id)),s=T(e,t,()=>({id:te(`folder`),name:`기본 폴더`,createdAt:Date.now()}));_e(s),n===t&&r(s.folders[0]?.id??``),i!==null&&o.has(i)&&(a(s.files[0]?.id??null),u(0),p(0)),h(t=>ue(t,e.files,o))}return(0,A.jsxs)(`div`,{className:[`app-shell`,o===`exam`&&ee?`exam-chrome-collapsed`:``].filter(Boolean).join(` `),"data-testid":`app-shell`,"data-theme":v,children:[(0,A.jsx)(be,{folders:e.folders,files:e.files,selectedFolderId:n,selectedFileId:i,onAddFolder:xe,isDeleteMode:b,onImportFile:Se,onDeleteFile:Te,onDeleteFolder:Ee,onSelectFolder:e=>{r(e),a(null),u(0),p(0)},onSelectFile:t=>{let n=e.files.find(e=>e.id===t);n!==void 0&&r(n.folderId),a(t),u(0),p(0)},theme:v,onToggleTheme:()=>y(e=>e===`opencode`?`resend`:`opencode`),onToggleDeleteMode:()=>x(e=>!e)}),(0,A.jsxs)(`main`,{className:`main-pane`,children:[(0,A.jsx)(we,{mode:o,theme:v,onChangeMode:s,onToggleTheme:()=>y(e=>e===`opencode`?`resend`:`opencode`)}),(0,A.jsx)(`section`,{className:`content-scroll`,children:pe===null?(0,A.jsx)(De,{}):(0,A.jsx)(St,{mode:o,file:pe,attempts:e.attempts,examDrafts:e.examDrafts,answerOverrides:e.answerOverrides,currentIndex:c,examIndex:f,isExamChromeCollapsed:ee,currentQuestion:O,orderMode:C,revealed:m,onToggleOrder:()=>{C===`sequential`&&oe(e=>e+1),re(C===`sequential`?`shuffle`:`sequential`),u(0),p(0)},onReveal:e=>h(t=>E(t,e)),onMove:u,onMoveExam:p,onToggleExamChrome:()=>S(e=>!e),onSaveAttempt:t=>me([...e.attempts,t]),onSaveAnswerOverride:ge,onSaveExamDraft:ve,onClearExamDraft:ye})}),(0,A.jsx)(Oe,{message:g})]})]})}var At=document.getElementById(`root`);if(At===null)throw Error(`Root element #root was not found.`);(0,u.createRoot)(At).render((0,A.jsx)(l.StrictMode,{children:(0,A.jsx)(kt,{})}));