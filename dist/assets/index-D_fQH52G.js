...
`).trim()}function te(e){return`${e}_${Date.now().toString(36)}_${crypto.randomUUID().slice(0,8)}`}function ne(e,t,n){return{id:te(`file`),folderId:e,name:t,content:n,questions:g(n),importedAt:Date.now()}}function re(e,t){return{...e,files:e.files.filter(e=>e.id!==t),attempts:e.attempts.filter(e=>e.fileId!==t),answerOverrides:e.answerOverrides.filter(e=>e.fileId!==t),examDrafts:e.examDrafts.filter(e=>e.fileId!==t)}}function w(e,t,n){let r=new Set(e.files.filter(e=>e.folderId===t).map(e=>e.id)),i=e.folders.filter(e=>e.id!==t);return{...e,folders:i.length>0?i:[n()],files:e.files.filter(e=>!r.has(e.id)),attempts:e.attempts.filter(e=>!r.has(e.fileId)),answerOverrides:e.answerOverrides.filter(e=>!r.has(e.fileId)),examDrafts:e.examDrafts.filter(e=>!r.has(e.fileId))}}var ie=`# 정보처리기사 실기 개념요약본 (1~5과목)
...
`;function oe(e,t){if(e.folders.length>0)return e;let n={...e,folders:[ce],files:le};return t(n),n}var se=Date.UTC(2026,6,7),ce={id:`folder_doc`,name:`doc`,createdAt:se},le=[ue(`doc_concept_summary`,`정보처리기사_실기_개념요약본.md`,ie),ue(`doc_written_200`,`정보처리기사_실기_주관식_200제.md`,ae)];function ue(e,t,n){return{id:e,folderId:ce.id,name:t,content:n,questions:g(n),importedAt:se}}function T(e,t){let n=new Set(e);return n.has(t)?n.delete(t):n.add(t),n}function E(e,t,n){let r=new Set(e);return t.find(e=>e.id===n)?.questions.forEach(e=>{r.delete(e.id)}),r}function de(e,t,n){let r=new Set(e);return t.filter(e=>n.has(e.id)).flatMap(e=>e.questions).forEach(e=>{r.delete(e.id)}),r}function fe(e,t){if(e===null)return null;let n=t.filter(t=>t.folderId===e.id);if(n.length===0)return null;let r=n.flatMap(t=>t.questions.map(n=>({...n,id:`${t.id}_${n.id}`,sourceFileName:t.name,sourceFolderName:e.name})));return{id:`folder_${e.id}`,folderId:e.id,name:e.name,content:n.map(e=>e.content).join(`

`),questions:r,importedAt:Math.max(...n.map(e=>e.importedAt))}}function pe(e,t,n){if(e===null)return null;let r=t===`sequential`?e.questions:me(e.questions,e.id,n);return{...e,questions:r.map((e,t)=>({...e,index:t+1}))}}function me(e,t,n){if(e.length<2)return e;let r=n%(e.length-1)+1,i=e[r];if(i===void 0)return e;let a=e.filter((e,t)=>t!==r),o=D(`${t}_${n}`);for(let e=a.length-1;e>0;--e){o=O(o);let t=o%(e+1),n=a[e],r=a[t];n===void 0||r===void 0||(a[e]=r,a[t]=n)}return[i,...a]}function D(e){let t=0;for(let n of e)t=t*31+n.charCodeAt(0)>>>0;return t}function O(e){return e*1664525+1013904223>>>0}var he={folders:[],files:[],attempts:[],answerOverrides:[],examDrafts:[]},ge=`STUDY_VIEWER_LIBRARY_V1`;function _e(e=window.localStorage){return{load:()=>ve(e),saveLibrary:t=>ye(e,t),saveFolders:t=>ye(e,{...ve(e),folders:t}),saveFiles:t=>ye(e,{...ve(e),files:t}),saveAttempts:t=>ye(e,{...ve(e),attempts:t}),saveAnswerOverrides:t=>ye(e,{...ve(e),answerOverrides:t}),saveExamDrafts:t=>ye(e,{...ve(e),examDrafts:t})}}function ve(e){let t=e.getItem(ge);if(t===null)return he;let n=JSON.parse(t);return{folders:Array.isArray(n.folders)?n.folders:[],files:Array.isArray(n.files)?n.files:[],attempts:Array.isArray(n.attempts)?n.attempts:[],answerOverrides:Array.isArray(n.answerOverrides)?n.answerOverrides:[],examDrafts:Array.isArray(n.examDrafts)?n.examDrafts:[]}}function ye(e,t){e.setItem(ge,JSON.stringify(t))}var be=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),k=e(((e,t)=>{t.exports=be()}))();function xe(e){return(0,k.jsxs)(`aside`,{className:`sidebar`,children:[(0,k.jsxs)(`div`,{className:`brand`,children:[(0,k.jsx)(`div`,{className:`brand-icon`,children:`SV`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h1`,{children:`STUDY_VIEWER`}),(0,k.jsx)(`p`,{children:`Local exam workspace`})]})]}),(0,k.jsx)(`nav`,{className:`tree`,"aria-label":`folder tree`,children:e.folders.map(t=>(0,k.jsxs)(`section`,{className:`folder-block`,children:[(0,k.jsxs)(`div`,{className:`tree-item`,children:[(0,k.jsxs)(`button`,{className:t.id===e.selectedFolderId?`tree-row active`:`tree-row`,type:`button`,onClick:()=>e.onSelectFolder(t.id),children:[(0,k.jsx)(we,{}),(0,k.jsx)(`span`,{children:t.name})]}),e.isDeleteMode?(0,k.jsx)(Se,{label:`${t.name} 폴더 삭제`,onClick:()=>e.onDeleteFolder(t.id)}):null]}),e.files.filter(e=>e.folderId===t.id).map(t=>(0,k.jsxs)(`div`,{className:`tree-item file-item`,children:[(0,k.jsxs)(`button`,{className:t.id===e.selectedFileId?`file-row active`:`file-row`,type:`button`,onClick:()=>e.onSelectFile(t.id),children:[(0,k.jsx)(`span`,{children:t.name}),(0,k.jsxs)(`small`,{children:[t.questions.length,`문제`]})]}),e.isDeleteMode?(0,k.jsx)(Se,{label:`${t.name} 파일 삭제`,onClick:()=>e.onDeleteFile(t.id)}):null]},t.id))]},t.id))}),(0,k.jsxs)(`div`,{className:`sidebar-actions`,children:[(0,k.jsx)(`button`,{className:`primary`,type:`button`,onClick:e.onAddFolder,children:`Add Folder`}),(0,k.jsx)(`button`,{"aria-pressed":e.isDeleteMode,className:e.isDeleteMode?`danger active`:`danger`,type:`button`,onClick:e.onToggleDeleteMode,children:e.isDeleteMode?`Deleting...`:`Delete`}),(0,k.jsxs)(`label`,{className:`secondary`,children:[`Import File`,(0,k.jsx)(`input`,{"aria-label":`md/txt 불러오기`,accept:`.md,.txt,text/markdown,text/plain`,type:`file`,onChange:t=>{let n=t.currentTarget.files?.[0];n!==void 0&&e.onImportFile(n),t.currentTarget.value=``}})]})]}),(0,k.jsx)(`button`,{"aria-label":`Resend night theme`,"aria-pressed":e.theme===`resend`,className:`theme-toggle`,type:`button`,onClick:e.onToggleTheme,children:(0,k.jsx)(Ce,{})})]})}function Se({label:e,onClick:t}){return(0,k.jsx)(`button`,{"aria-label":e,className:`delete-mark`,type:`button`,onClick:e=>{e.stopPropagation(),t()},children:`x`})}function Ce(){return(0,k.jsx)(`svg`,{"aria-hidden":`true`,fill:`none`,height:`18`,viewBox:`0 0 24 24`,width:`18`,xmlns:`http://www.w3.org/2000/svg`,children:(0,k.jsx)(`path`,{d:`M20.2 15.4A8.6 8.6 0 0 1 8.6 3.8a8.7 8.7 0 1 0 11.6 11.6Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function we(){return(0,k.jsx)(`svg`,{"aria-hidden":`true`,className:`folder-icon`,fill:`none`,height:`16`,viewBox:`0 0 24 24`,width:`16`,xmlns:`http://www.w3.org/2000/svg`,children:(0,k.jsx)(`path`,{d:`M3.8 6.6c0-.9.7-1.6 1.6-1.6h4.2l2 2h7c.9 0 1.6.7 1.6 1.6v8.8c0 .9-.7 1.6-1.6 1.6H5.4c-.9 0-1.6-.7-1.6-1.6V6.6Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})})}function Te({mode:e,onChangeMode:t}){return(0,k.jsxs)(`header`,{className:`topbar`,children:[(0,k.jsx)(`strong`,{children:`Workspace Reader`}),(0,k.jsx)(`nav`,{children:[{mode:`single`,label:`단건보기`},{mode:`all`,label:`모두보기`},{mode:`exam`,label:`시험보기`},{mode:`stats`,label:`통계`}].map(n=>(0,k.jsx)(`button`,{className:e===n.mode?`tab active`:`tab`,type:`button`,onClick:()=>t(n.mode),children:n.label},n.mode))}),(0,k.jsx)(`input`,{"aria-label":`Search files`,placeholder:`Search files...`})]})}function Ee(){return(0,k.jsxs)(`div`,{className:`empty`,children:[(0,k.jsx)(`h2`,{children:`파일을 불러오면 문제가 표시됩니다.`}),(0,k.jsx)(`p`,{children:`왼쪽 메뉴에서 md/txt 파일을 불러오세요.`})]})}function De({message:e}){return(0,k.jsx)(`div`,{className:e.length>0?`toast show`:`toast`,children:e})}function Oe(e,t){let n=new Map;for(let r of e)r.fileId===t&&n.set(r.questionId,r.answer);return n}function ke(e,t=new Map){return t.get(e.id)??e.answer}function Ae(e){return e.normalize(`NFC`).trim().replace(/^[\s.,;:!?。、，]+|[\s.,;:!?。、，]+$/gu,``).replace(/\s+/gu,` `).toLocaleLowerCase(`ko-KR`)}function je(e,t){if(t===null)return!1;let n=Ae(e);return n.length>0&&n===Ae(t)}function Me(e,t){return t?.includes("`")===!0&&f(t)===e?t:e}function Ne(e,t,n=new Map){let r={},i=0,a=0;for(let o of e){let e=ke(o,n);if(e===null)continue;a+=1;let s=je(t[o.id]??``,e);r[o.id]=s,s&&(i+=1)}return{results:r,score:i,total:a}}function Pe(e){let t=e.index>=e.total-1;return(0,k.jsxs)(`footer`,{className:`answer-footer`,children:[(0,k.jsxs)(`section`,{children:[(0,k.jsx)(`h3`,{children:`답안 작성 영역`}),(0,k.jsx)(`textarea`,{value:e.answer,onChange:t=>e.onAnswer(t.currentTarget.value),placeholder:`답을 입력하세요`,disabled:e.disabled}),(0,k.jsx)(`div`,{className:`footer-buttons`,children:(0,k.jsx)(`button`,{className:`primary`,type:`button`,onClick:e.onSave,disabled:e.question===null||e.disabled,children:`저장`})})]}),(0,k.jsxs)(`nav`,{children:[(0,k.jsx)(`button`,{type:`button`,onClick:e.onPrev,children:`이전 문항`}),(0,k.jsxs)(`strong`,{children:[`QUESTION `,e.total===0?0:e.index+1,` / `,e.total]}),(0,k.jsx)(`button`,{type:`button`,onClick:t?e.onSubmit:e.onNext,children:t?`제출 완료`:`다음 문항`})]})]})}function Fe({answered:e,total:t,timerText:n,orderMode:r,onToggleOrder:i,onReset:a}){let o=t===0?0:Math.round(e/t*100);return(0,k.jsxs)(`section`,{className:`progress-strip`,children:[(0,k.jsxs)(`div`,{className:`progress-status`,children:[(0,k.jsx)(`span`,{children:`진행도 (Test Progress)`}),(0,k.jsx)(`div`,{className:`bar`,children:(0,k.jsx)(`div`,{style:{width:`${o}%`}})}),(0,k.jsxs)(`strong`,{children:[`Answered `,e,` / `,t]})]}),(0,k.jsx)(Le,{orderMode:r,onToggleOrder:i}),(0,k.jsxs)(`div`,{className:`progress-time`,children:[a===void 0?null:(0,k.jsx)(`button`,{"aria-label":`새로고침`,className:`timer-reset`,type:`button`,onClick:a,children:`↻`}),n===void 0?null:(0,k.jsx)(`span`,{className:`timer-chip`,children:n})]})]})}function Ie({orderMode:e,onToggleOrder:t}){return(0,k.jsx)(`section`,{className:`order-strip`,children:(0,k.jsx)(Le,{orderMode:e,onToggleOrder:t})})}function Le({orderMode:e,onToggleOrder:t}){return(0,k.jsx)(`button`,{className:`order-toggle`,type:`button`,onClick:t,children:e===`sequential`?`순차`:`무작위`})}function Re({text:e}){return(0,k.jsx)(`div`,{className:`question-prompt`,children:Be(e).map(e=>e.kind===`codeBlock`?(0,k.jsx)(`pre`,{className:`question-code-block`,"data-language":e.language,children:(0,k.jsx)(`code`,{children:Ue(e.value,e.id,e.language)})},e.id):(0,k.jsx)(`p`,{children:He(e.value,e.id)},e.id))})}function ze({text:e}){return(0,k.jsx)(k.Fragment,{children:He(e,`inline`)})}function Be(e){let t=[],n=[],r=[],i=`plaintext`,a=!1;for(let o of e.split(`
`)){let e=We(o);if(e!==null){if(a){t.push({id:`code-${t.length}-${r.join(`
`).length}`,kind:`codeBlock`,language:i,value:r.join(`
`)}),r.length=0,i=`plaintext`,a=!1;continue}Ve(t,n),i=e,a=!0;continue}if(a){r.push(o);continue}n.push(o)}return a&&t.push({id:`code-${t.length}-${r.join(`
`).length}`,kind:`codeBlock`,language:i,value:r.join(`
`)}),Ve(t,n),t.length>0?t:[{id:`text-empty-${e.length}`,kind:`text`,value:e}]}function Ve(e,t){if(t.length===0)return;let n=t.join(`
`).trim();t.length=0,n.length!==0&&e.push({id:`text-${e.length}-${n.length}`,kind:`text`,value:n})}function He(e,t){let n=[],r=e,i=0;for(;r.length>0;){let e=r.indexOf("`");if(e<0){n.push(r);break}let a=r.slice(0,e);a.length>0&&n.push(a);let o=r.slice(e+1),s=o.indexOf("`");if(s<0){n.push(r.slice(e));break}let c=o.slice(0,s);n.push((0,k.jsx)(`code`,{className:`question-inline-code`,children:c},`code-${t}-${i}`)),i+=1,r=o.slice(s+1)}return n}function Ue(e,t,n){let r=[],i=0,a=Ke(n);for(let o of e.matchAll(a)){let a=o[0],s=o.index;s>i&&r.push(e.slice(i,s)),r.push((0,k.jsx)(`span`,{className:`code-token ${Je(a,n)}`,children:a},`${t}-${s}`)),i=s+a.length}return i<e.length&&r.push(e.slice(i)),r}function We(e){let t=/^\s*```(?<language>[a-z0-9_-]*)/iu.exec(e);return t===null?null:Ge(t.groups?.language??``)}function Ge(e){let t=e.toLowerCase();return t===`js`||t===`jsx`?`javascript`:t===`ts`||t===`tsx`?`typescript`:t===`py`?`python`:t===`kt`?`kotlin`:t===`md`?`markdown`:t===`htm`?`html`:t===`css`||t===`html`||t===`java`||t===`json`||t===`kotlin`||t===`markdown`||t===`python`||t===`sql`||t===`typescript`?t:`plaintext`}function Ke(e){let t=qe(e);return new RegExp([/#.*/u.source,/--.*/u.source,/\/\/.*/u.source,/"(?:\\.|[^"\\])*"/u.source,/'(?:\\.|[^'\\])*'/u.source,/`(?:\\.|[^`\\])*`/u.source,t,/\b\d+(?:\.\d+)?\b/u.source].filter(e=>e.length>0).join(`|`),`gu`)}function qe(e){let t={css:[`align-items`,`background`,`border`,`color`,`display`,`font`,`grid`,`margin`,`padding`],html:[`article`,`body`,`button`,`div`,`footer`,`head`,`header`,`html`,`main`,`section`],java:[`boolean`,`class`,`else`,`false`,`final`,`if`,`import`,`new`,`null`,`private`,`public`,`return`,`static`,`true`,`void`],javascript:[`async`,`await`,`class`,`const`,`else`,`export`,`false`,`from`,`function`,`if`,`import`,`let`,`new`,`null`,`return`,`true`,`undefined`,`var`,`while`],json:[`false`,`null`,`true`],kotlin:[`class`,`data`,`else`,`false`,`fun`,`if`,`import`,`null`,`object`,`return`,`true`,`val`,`var`,`when`],markdown:[],plaintext:[],python:[`and`,`as`,`class`,`def`,`elif`,`else`,`False`,`for`,`from`,`if`,`import`,`in`,`is`,`None`,`not`,`or`,`return`,`True`,`while`],sql:[`and`,`as`,`by`,`case`,`create`,`delete`,`from`,`group`,`insert`,`into`,`join`,`left`,`limit`,`order`,`right`,`select`,`table`,`update`,`values`,`where`],typescript:[`async`,`await`,`class`,`const`,`else`,`export`,`false`,`from`,`function`,`if`,`import`,`interface`,`let`,`new`,`null`,`return`,`true`,`type`,`undefined`,`var`,`while`]}[e].join(`|`);return t.length===0?``:`\\b(?:${t})\\b`}function Je(e,t){return e.startsWith(`//`)||e.startsWith(`#`)||e.startsWith(`--`)?`comment`:e.startsWith(`"`)||e.startsWith(`'`)||e.startsWith("`")?`string`:/^\d/u.test(e)?`number`:t===`css`&&e.includes(`-`)?`property`:t===`html`?`tag`:`keyword`}function Ye({file:e,attempts:t,examDrafts:n,answerOverrides:r,orderMode:i,onToggleOrder:a,onSaveAttempt:o,onSaveExamDraft:s,onClearExamDraft:c}){let u=Qe(t,e.id),d=n.find(t=>t.fileId===e.id)??null,f=d===null?u:null,[p,m]=(0,l.useState)(d?.startedAt??Date.now()),[h,g]=(0,l.useState)(Date.now()),[_,v]=(0,l.useState)(0),[y,b]=(0,l.useState)(()=>d?.answers??f?.answers??{}),[x,ee]=(0,l.useState)(()=>new Set(Object.keys(d?.answers??f?.answers??{})));(0,l.useEffect)(()=>{if(f!==null)return;let e=window.setInterval(()=>g(Date.now()),1e3);return()=>window.clearInterval(e)},[f]),(0,l.useEffect)(()=>{let e=d?.answers??f?.answers??{};b(e),m(d?.startedAt??f?.startedAt??Date.now()),ee(new Set(Object.keys(e))),g(Date.now())},[d,f]);let S=e.questions[_]??null,C=Oe(r,e.id),ne=e.questions.filter(e=>(y[e.id]??``).trim().length>0).length,re=tt(f?.durationMs??h-p),w=f!==null;function ie(){if(S===null)return;let t=y;s({fileId:e.id,answers:t,startedAt:p}),ee(e=>new Set(e).add(S.id))}function ae(){if(S===null)return;let n=Date.now(),r=Ne(e.questions,y,C);o({id:te(`attempt`),fileId:e.id,round:t.filter(t=>t.fileId===e.id).length+1,answers:y,results:r.results,score:r.score,total:r.total,startedAt:p,finishedAt:n,durationMs:n-p}),c(e.id),ee(new Set(e.questions.map(e=>e.id)))}function oe(){let t=Date.now(),n={};s({fileId:e.id,answers:n,startedAt:t}),m(t),b(n),ee(new Set),v(0),g(t)}return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(Fe,{answered:ne,total:e.questions.length,timerText:re,orderMode:i,onToggleOrder:a,onReset:oe}),(0,k.jsx)(`div`,{className:`exam`,children:S===null?(0,k.jsx)($e,{}):(0,k.jsx)(Xe,{question:S,correctAnswer:ke(S,C),reference:`${et(S,e.name)} · QUESTION ${_+1} / ${e.questions.length}`,answer:y[S.id]??``,isSaved:w||x.has(S.id)})}),(0,k.jsx)(Pe,{question:S,index:_,total:e.questions.length,answer:S===null?``:y[S.id]??``,disabled:w,onAnswer:e=>{S!==null&&b(t=>({...t,[S.id]:e}))},onSave:ie,onPrev:()=>v(Math.max(0,_-1)),onNext:()=>v(Math.min(e.questions.length-1,_+1)),onSubmit:ae})]})}function Xe({question:e,correctAnswer:t,reference:n,answer:r,isSaved:i}){let a=je(r,t);return(0,k.jsxs)(`article`,{className:`question-card`,children:[(0,k.jsxs)(`div`,{className:`question-meta`,children:[(0,k.jsxs)(`span`,{children:[`Question `,e.index.toString().padStart(2,`0`)]}),(0,k.jsx)(`small`,{children:n})]}),(0,k.jsx)(Re,{text:e.prompt}),i?(0,k.jsx)(Ze,{answer:t,rawAnswer:e.rawAnswer,isCorrect:a}):null]})}function Ze({answer:e,rawAnswer:t,isCorrect:n}){return e===null?(0,k.jsx)(`div`,{className:`mask neutral`,children:`정답 구문 없음`}):(0,k.jsxs)(`div`,{className:`exam-saved-answer`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(ze,{text:`정답: ${Me(e,t)}`})}),(0,k.jsx)(`strong`,{className:n?`result correct`:`result wrong`,children:n?`정답입니다`:`오답입니다`})]})}function Qe(e,t){return e.filter(e=>e.fileId===t).at(-1)??null}function $e(){return(0,k.jsx)(`div`,{className:`empty`,children:(0,k.jsx)(`h2`,{children:`시험 볼 문제가 없습니다.`})})}function et(e,t){return e.sourceFolderName!==void 0&&e.sourceFileName!==void 0?`${e.sourceFolderName} - ${e.sourceFileName}`:t}function tt(e){let t=Math.floor(e/1e3);return`${Math.floor(t/3600).toString().padStart(2,`0`)}:${Math.floor(t%3600/60).toString().padStart(2,`0`)}:${(t%60).toString().padStart(2,`0`)}`}function nt({question:e,answer:t,variant:n,onConceal:r,onEdit:i}){let[a,o]=(0,l.useState)(!1),s=(0,l.useRef)(null);return(0,l.useEffect)(()=>()=>{s.current!==null&&window.clearTimeout(s.current)},[]),t===null?(0,k.jsx)(`div`,{className:`visible-answer neutral`,children:`정답 구문 없음`}):(0,k.jsxs)(`div`,{className:a?`answer-editable raw-mode`:`answer-editable`,children:[(0,k.jsx)(`button`,{className:n===`mask`?`mask revealed`:`visible-answer`,type:`button`,onClick:e=>{n!==`mask`||r===void 0||e.detail===1&&(s.current=window.setTimeout(r,180))},onDoubleClick:()=>{s.current!==null&&window.clearTimeout(s.current),o(e=>!e)},children:(0,k.jsx)(ze,{text:a?e.rawAnswer??t:`정답: ${Me(t,e.rawAnswer)}`})}),i===void 0?null:(0,k.jsx)(`button`,{className:`answer-edit`,type:`button`,onClick:()=>{let e=window.prompt(`정답을 수정하세요`,t)?.trim();e===void 0||e.length===0||(i(e),o(!1))},children:`정답 수정`})]})}function rt({question:e,effectiveAnswer:t,revealed:n,onReveal:r,onSaveAnswerOverride:i,reference:a,answerMode:o}){return(0,k.jsxs)(`article`,{className:`question-card`,children:[(0,k.jsxs)(`div`,{className:`question-meta`,children:[(0,k.jsxs)(`span`,{children:[`Question `,e.index.toString().padStart(2,`0`)]}),(0,k.jsx)(`small`,{children:a})]}),(0,k.jsx)(Re,{text:e.prompt}),o===`mask`?(0,k.jsx)(it,{question:e,answer:t,revealed:n,onReveal:r,...i===void 0?{}:{onSaveAnswerOverride:i}}):(0,k.jsx)(nt,{question:e,answer:t,variant:`visible`})]})}function it({question:e,answer:t,revealed:n,onReveal:r,onSaveAnswerOverride:i}){return t===null?(0,k.jsx)(`div`,{className:`mask neutral`,children:`정답 구문 없음`}):n?(0,k.jsx)(nt,{question:e,answer:t,variant:`mask`,onConceal:r,...i===void 0?{}:{onEdit:i}}):(0,k.jsx)(`button`,{className:`mask`,type:`button`,onClick:r,children:`정답 보기`})}function at(e,t,n){return e.flatMap(e=>e.questions.map(r=>{let i=t.filter(t=>t.fileId===e.id).filter(e=>e.results[r.id]!==void 0),a=i.filter(e=>e.results[r.id]===!1).length,o=i.length,s=o===0?0:a/o;return{questionId:r.id,fileId:e.id,label:`${e.name} · ${r.index}번`,attempts:o,wrong:a,wrongRate:s,highlighted:o>0&&s>=n}}))}var ot=.5;function st({files:e,attempts:t}){let n=(0,l.useMemo)(()=>at(e,t,ot),[e,t]);return(0,k.jsxs)(`div`,{className:`stats`,children:[(0,k.jsx)(`h2`,{children:`통계`}),t.length===0?(0,k.jsx)(`p`,{children:`저장된 응시 결과가 없습니다.`}):null,n.map(e=>(0,k.jsxs)(`div`,{className:e.highlighted?`stat-row hot`:`stat-row`,children:[(0,k.jsx)(`span`,{children:e.label}),(0,k.jsxs)(`strong`,{children:[`오답률 `,Math.round(e.wrongRate*100),`%`]}),(0,k.jsxs)(`small`,{children:[e.wrong,`/`,e.attempts]})]},`${e.fileId}_${e.questionId}`))]})}function ct(e){return e.mode===`all`?(0,k.jsx)(ut,{...e}):e.mode===`exam`?(0,k.jsx)(Ye,{file:e.file,attempts:e.attempts,examDrafts:e.examDrafts,answerOverrides:e.answerOverrides,orderMode:e.orderMode,onToggleOrder:e.onToggleOrder,onSaveAttempt:e.onSaveAttempt,onSaveExamDraft:e.onSaveExamDraft,onClearExamDraft:e.onClearExamDraft}):e.mode===`stats`?(0,k.jsx)(st,{files:[e.file],attempts:e.attempts}):(0,k.jsx)(lt,{...e})}function lt(e){if(e.currentQuestion===null)return(0,k.jsx)(ft,{});let t=e.currentQuestion,n=Oe(e.answerOverrides,e.file.id);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(Ie,{orderMode:e.orderMode,onToggleOrder:e.onToggleOrder}),(0,k.jsx)(rt,{question:t,effectiveAnswer:ke(t,n),revealed:e.revealed.has(t.id),onReveal:()=>e.onReveal(t.id),onSaveAnswerOverride:n=>e.onSaveAnswerOverride({fileId:e.file.id,questionId:t.id,answer:n,updatedAt:Date.now()}),reference:`${pt(t,e.file.name)} · QUESTION ${e.currentIndex+1} / ${e.file.questions.length}`,answerMode:`mask`}),(0,k.jsx)(dt,{index:e.currentIndex,total:e.file.questions.length,onPrev:()=>e.onMove(Math.max(0,e.currentIndex-1)),onNext:()=>e.onMove(Math.min(e.file.questions.length-1,e.currentIndex+1))})]})}function ut(e){if(e.file.questions.length===0)return(0,k.jsx)(ft,{});let t=Oe(e.answerOverrides,e.file.id);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(Ie,{orderMode:e.orderMode,onToggleOrder:e.onToggleOrder}),(0,k.jsx)(`div`,{className:`stack`,children:e.file.questions.map(n=>(0,k.jsx)(rt,{question:n,effectiveAnswer:ke(n,t),revealed:!1,onReveal:()=>void 0,reference:pt(n,e.file.name),answerMode:`visible`},n.id))})]})}function dt({index:e,total:t,onPrev:n,onNext:r}){return(0,k.jsxs)(`footer`,{className:`single-navigation`,children:[(0,k.jsx)(`button`,{type:`button`,onClick:n,children:`이전 문항`}),(0,k.jsxs)(`strong`,{children:[`QUESTION `,t===0?0:e+1,` / `,t]}),(0,k.jsx)(`button`,{type:`button`,onClick:r,children:`다음 문항`})]})}function ft(){return(0,k.jsxs)(`div`,{className:`empty`,children:[(0,k.jsx)(`h2`,{children:`표시할 문제가 없습니다.`}),(0,k.jsx)(`p`,{children:`답: 또는 정답: 구문이 없는 파일도 안전하게 불러올 수 있습니다.`})]})}function pt(e,t){return e.sourceFolderName!==void 0&&e.sourceFileName!==void 0?`${e.sourceFolderName} - ${e.sourceFileName}`:t}var mt=_e();function ht(){let[e,t]=(0,l.useState)(()=>oe(mt.load(),mt.saveLibrary)),[n,r]=(0,l.useState)(()=>e.folders[0]?.id??``),[i,a]=(0,l.useState)(e.files[0]?.id??null),[o,s]=(0,l.useState)(`single`),[c,u]=(0,l.useState)(0),[f,p]=(0,l.useState)(new Set),[m,h]=(0,l.useState)(``),[g,_]=(0,l.useState)(`opencode`),[v,y]=(0,l.useState)(!1),[b,x]=(0,l.useState)(`sequential`),[ee,S]=(0,l.useState)(0),C=e.files.find(e=>e.id===i)??null,ie=e.folders.find(e=>e.id===n)??e.folders[0],ae=(0,l.useMemo)(()=>C??fe(ie??null,e.files),[e.files,ie,C]),se=(0,l.useMemo)(()=>pe(ae,b,ee),[b,ae,ee]),ce=se?.questions[c]??null;(0,l.useEffect)(()=>{if(m.length===0)return;let e=window.setTimeout(()=>h(``),1800);return()=>window.clearTimeout(e)},[m]);function le(e){mt.saveFiles(e),t(t=>({...t,files:e}))}function ue(e){mt.saveAttempts(e),t(t=>({...t,attempts:e}))}function me(e){mt.saveExamDrafts(e),t(t=>({...t,examDrafts:e}))}function D(n){let r=d(e.answerOverrides,n);mt.saveAnswerOverrides(r),t(e=>({...e,answerOverrides:r}))}function O(e){mt.saveLibrary(e),t(e)}function he(t){me([...e.examDrafts.filter(e=>e.fileId!==t.fileId),t])}function ge(t){me(e.examDrafts.filter(e=>e.fileId!==t))}function _e(){let n=window.prompt(`폴더명을 입력하세요`,`새 폴더`)?.trim();if(n===void 0||n.length===0)return;let i={id:te(`folder`),name:n,createdAt:Date.now()},o=[...e.folders,i];mt.saveFolders(o),t(e=>({...e,folders:o})),r(i.id),a(null),u(0)}async function ve(e){let t=await e.text();ye(e.name,t)}function ye(t,n){let r=ie?.id??e.folders[0]?.id;if(r===void 0)return;let i=ne(r,t,n);le([...e.files,i]),a(i.id),u(0),h(`${t} 불러오기 완료`)}function be(t){let n=re(e,t);O(n),i===t&&(a(n.files[0]?.id??null),u(0)),p(n=>E(n,e.files,t))}function Se(t){let o=new Set(e.files.filter(e=>e.folderId===t).map(e=>e.id)),s=w(e,t,()=>({id:te(`folder`),name:`기본 폴더`,createdAt:Date.now()}));O(s),n===t&&r(s.folders[0]?.id??``),i!==null&&o.has(i)&&(a(s.files[0]?.id??null),u(0)),p(t=>de(t,e.files,o))}return(0,k.jsxs)(`div`,{className:`app-shell`,"data-testid":`app-shell`,"data-theme":g,children:[(0,k.jsx)(xe,{folders:e.folders,files:e.files,selectedFolderId:n,selectedFileId:i,onAddFolder:_e,isDeleteMode:v,onImportFile:ve,onDeleteFile:be,onDeleteFolder:Se,onSelectFolder:e=>{r(e),a(null),u(0)},onSelectFile:t=>{let n=e.files.find(e=>e.id===t);n!==void 0&&r(n.folderId),a(t),u(0)},theme:g,onToggleTheme:()=>_(e=>e===`opencode`?`resend`:`opencode`),onToggleDeleteMode:()=>y(e=>!e)}),(0,k.jsxs)(`main`,{className:`main-pane`,children:[(0,k.jsx)(Te,{mode:o,onChangeMode:s}),(0,k.jsx)(`section`,{className:`content-scroll`,children:se===null?(0,k.jsx)(Ee,{}):(0,k.jsx)(ct,{mode:o,file:se,attempts:e.attempts,examDrafts:e.examDrafts,answerOverrides:e.answerOverrides,currentIndex:c,currentQuestion:ce,orderMode:b,revealed:f,onToggleOrder:()=>{b===`sequential`&&S(e=>e+1),x(b===`sequential`?`shuffle`:`sequential`),u(0)},onReveal:e=>p(t=>T(t,e)),onMove:u,onSaveAttempt:t=>ue([...e.attempts,t]),onSaveAnswerOverride:D,onSaveExamDraft:he,onClearExamDraft:ge})}),(0,k.jsx)(De,{message:m})]})]})}var gt=document.getElementById(`root`);if(gt===null)throw Error(`Root element #root was not found.`);(0,u.createRoot)(gt).render((0,k.jsx)(l.StrictMode,{children:(0,k.jsx)(ht,{})}));